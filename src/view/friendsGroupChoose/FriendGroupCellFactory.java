 ...
 * @param <T>
 */
public class FriendGroupCellFactory<T> extends ListCell<T> {
        ...
        if (item == null || empty) {
            ...
            try {
                if (item instanceof Chat) {
                    ...
                    FriendGroupCellController controller = loader.getController();
                    ...
                    this.setOnMousePressed(new EventHandler() {
                        ...
                        public void handle(Event event) {
                            try {
                                ...
                                Logger.getLogger(FriendGroupCellFactory.class.getName()).log(Level.SEVERE, null, ex);
